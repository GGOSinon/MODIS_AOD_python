...
FILE_NAME = '/media/guitar79/4TB1/MODIS_AOD/DAAC_MOD04_3K/H28V05/MYD04_3K.A2016366.0440.006.2017010010311.hdf'
...
latitude = lat[:,:]
latitude = np.reshape(latitude, (1, latitude.shape[0]*latitude.shape[1]))
lon = hdf.select('Longitude')
longitude = lon[:,:]
longitude = np.reshape(longitude, (1, longitude.shape[0]*longitude.shape[1]))

m = Basemap(projection='cyl', resolution='h', llcrnrlat=10, urcrnrlat = 60, llcrnrlon=100, urcrnrlon = 160)
#m = Basemap(projection='stere', resolution='h', llcrnrlat=10, urcrnrlat = 60, llcrnrlon=100, urcrnrlon = 160)
